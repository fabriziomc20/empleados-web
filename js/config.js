...
// =========================
// USUARIOS & PERMISOS (Acceso a la app) - SOLO INVITACIÓN
// =========================
...
function readAdvancedPerms(){
  // Si el admin no abrió el details, dejamos que el server aplique matriz por rol
  const d = {
